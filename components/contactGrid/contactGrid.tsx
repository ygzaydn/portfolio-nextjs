...
const ContactGrid: React.FC = () => {
    return (
        <motion.div
            ...
            className="group/stack relative flex flex-col max-w-7xl mx-auto px-16 my-36 bg-slate-100 py-6 rounded-xl ring-2 ring-blue-800 border-2 sm:overflow-x-hidden"
            id="contactGrid"
        >
            <motion.div
                initial="hidden"
